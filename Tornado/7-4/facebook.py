...
class FeedHandler(tornado.web.RequestHandler, tornado.auth.FacebookGraphMixin):
    ...
    def get(self, *args, **kwargs):
        ...
        self.facebook_request(
            ...
            callback=functools.partial(self._on_facebook_user_feed)
        )
    ...
    def post(self, *args, **kwargs):
        ...
        self.facebook_request(
            ...
            callback=functools.partial(self._on_facebook_post_status)
        )
    ...
    def get(self, *args, **kwargs):
        ...
        if self.get_argument('code', None):
            self.get_authenticated_user(
                ...
                callback=functools.partial(self._on_facebook_login)
            )
            return
        ...
        self.authorize_redirect(
            redirect_uri='http://example.com/auth/login',
            client_id=self.settings['facebook_api_key'],
            extra_params={'scope' : 'read-stream,publish_stream'}
        )
