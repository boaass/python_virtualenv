...
class IndexHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        try:
            request = tornado.httpclient.HTTPRequest(url='https://api.github.com/search/repositories?q=%s+language:python&sort=stars&order=desc' % (query),
                                                     method='GET',
